...
const SEED_PRODUCTS: ProductDetail[] = [
  { id:"1", name:"Kikoy Wrap Dress", slug:"kikoy-wrap-dress", description:"Vibrant stripe-print wrap dress in lightweight cotton — easy to wear, easy to style. A versatile piece that takes you from day to evening.", base_price:8500, compare_price:11000, category:"Woman", material:"100% Cotton", care_instructions:"Hand wash cold. Lay flat to dry.", is_featured:true, status:"active", product_images:[], skus:[{id:"s1",size:"S",color:null,color_hex:null,stock_quantity:4,sku_code:"KWD-S"},{id:"s2",size:"M",color:null,color_hex:null,stock_quantity:6,sku_code:"KWD-M"},{id:"s3",size:"L",color:null,color_hex:null,stock_quantity:3,sku_code:"KWD-L"}], product_videos:[] },
  { id:"2", name:"Bead Collar Shirt", slug:"maasai-bead-collar-shirt", description:"Clean Oxford cotton shirt with an intricately beaded collar detail. A sharp, conversation-starting piece for any occasion.", base_price:6200, compare_price:null, category:"Man", material:"100% Oxford Cotton", care_instructions:"Machine wash cold. Do not tumble dry.", is_featured:false, status:"active", product_images:[], skus:[{id:"s4",size:"S",color:null,color_hex:null,stock_quantity:2,sku_code:"MBS-S"},{id:"s5",size:"M",color:null,color_hex:null,stock_quantity:5,sku_code:"MBS-M"},{id:"s6",size:"L",color:null,color_hex:null,stock_quantity:4,sku_code:"MBS-L"}], product_videos:[] },
  { id:"3", name:"Ankara Print Jumpsuit", slug:"ankara-print-kids-jumpsuit", description:"Bold wax-print cotton jumpsuit with snap-leg fastening for easy dressing. Bright, comfortable, and built to keep up with your child.", base_price:4800, compare_price:null, category:"Children", material:"100% Wax-Print Cotton", care_instructions:"Machine wash warm.", is_featured:false, status:"active", product_images:[], skus:[{id:"s7",size:"2Y",color:null,color_hex:null,stock_quantity:8,sku_code:"APJ-2Y"},{id:"s8",size:"4Y",color:null,color_hex:null,stock_quantity:6,sku_code:"APJ-4Y"},{id:"s9",size:"6Y",color:null,color_hex:null,stock_quantity:4,sku_code:"APJ-6Y"}], product_videos:[] },
  { id:"4", name:"Nairobi Linen Co-ord", slug:"nairobi-linen-co-ord", description:"Relaxed linen two-piece in a clean tailored cut. Wear together or as separates. The kind of outfit that looks better the more you wear it.", base_price:12400, compare_price:null, category:"Woman", material:"100% Linen", care_instructions:"Hand wash or dry clean.", is_featured:true, status:"active", product_images:[], skus:[{id:"s10",size:"S",color:null,color_hex:null,stock_quantity:3,sku_code:"NLC-S"},{id:"s11",size:"M",color:null,color_hex:null,stock_quantity:4,sku_code:"NLC-M"}], product_videos:[] },
  { id:"5", name:"Wax Print Relaxed Shirt", slug:"kitenge-baraza-shirt", description:"Relaxed open-hem shirt in a bold wax-cotton print. Easy-going and stylish — perfect for weekends, evenings, and everything in between.", base_price:5800, compare_price:null, category:"Man", material:"100% Wax-Print Cotton", care_instructions:"Hand wash cold.", is_featured:false, status:"active", product_images:[], skus:[{id:"s13",size:"M",color:null,color_hex:null,stock_quantity:5,sku_code:"KBS-M"},{id:"s14",size:"L",color:null,color_hex:null,stock_quantity:4,sku_code:"KBS-L"}], product_videos:[] },
  { id:"6", name:"Check Print Romper", slug:"shuka-check-romper", description:"Stretch cotton romper in a bold check print. Comfortable, easy to move in, and effortlessly stylish for little ones.", base_price:3200, compare_price:null, category:"Children", material:"95% Cotton, 5% Elastane", care_instructions:"Machine wash warm.", is_featured:false, status:"active", product_images:[], skus:[{id:"s16",size:"2Y",color:null,color_hex:null,stock_quantity:6,sku_code:"SCR-2Y"},{id:"s17",size:"4Y",color:null,color_hex:null,stock_quantity:5,sku_code:"SCR-4Y"}], product_videos:[] },
];
