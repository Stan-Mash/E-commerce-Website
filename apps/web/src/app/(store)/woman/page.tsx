...
export const metadata: Metadata = {
  title: "Women's Fashion Nairobi",
  description:
    "Shop curated women's fashion in Nairobi — tailored dresses, co-ords, and blazers in KES pricing with M-Pesa checkout and free Nairobi CBD delivery.",
  ...
  return (
    <main className="min-h-screen bg-es-paper">
      ...
      <div className="mx-auto w-full max-w-[1200px] px-6 py-10 sm:px-16 sm:py-20">
        <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Woman" }]} />
