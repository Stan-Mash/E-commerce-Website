...
async function getChildrenProducts(): Promise<ProductRow[]> {
  try {
    ...
    const { data, error } = await supabase
      ...
      .eq("status", "active")
      .in("category", ["children", "Children", "CHILDREN"])
  ...
  return (
    <main className="min-h-screen bg-es-paper">
      ...
      <div className="relative w-full" style={{ height: "60vh" }}>
        <ElitePlate kind="child" tone="sand" className="absolute inset-0" />
      ...
      <div className="mx-auto w-full max-w-[1200px] px-6 py-10 sm:px-16 sm:py-20">
        ...
        {products.length === 0 ? (
          <div className="flex flex-col items-start gap-6 py-10">
            ...
            <p style={{ fontFamily: "var(--font-cormorant)", fontStyle: "italic", fontSize: 18, color: "#717171", maxWidth: 420, lineHeight: 1.6 }}>
              We&apos;re adding childrenswear to the collection. See what&apos;s arriving next.
            </p>
